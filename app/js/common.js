...
// SVG
//  при клике выгружает данные в контейнер
...
// SVG END
	...
	// Адаптивные responsive таблицы
	var headertext = [],
		headers = document.querySelectorAll(".container-table th"),
		tablerows = document.querySelectorAll(".container-table th"),
	...
	// Plagin superfish для меню навигации---------------
...
// prognroll readprogress
// Плагин, показывает прогресс чтения странцы
$("body").prognroll({
	height: 5,
	color: "#2c923a",
	custom: false
});
// prognroll readprogress END